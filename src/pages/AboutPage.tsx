...
import { ArrowRight, Star, Users, Clock, Target, Award, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-900">
      ...
      <section className="relative pt-20 md:pt-24 pb-12 md:pb-20 overflow-hidden">
        ...
        <Container>
          ...
          >
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 md:mb-6 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">
              About Orange Cut Media
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-zinc-400 mb-4 sm:mb-6 md:mb-8">
            ...
            >
              <div className="flex items-center gap-1 sm:gap-2 text-zinc-400 text-xs sm:text-sm md:text-base">
                <Star className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-orange-500" />
                <span>Premium Quality</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2 text-zinc-400 text-xs sm:text-sm md:text-base">
                <Users className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-orange-500" />
      ...
      <section className="py-12 md:py-20 bg-zinc-950">
        <Container>
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 md:mb-6 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Our Mission</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              {[
                ...
                <motion.div
                  ...
                  className="bg-zinc-900/50 backdrop-blur-sm p-4 sm:p-5 md:p-6 rounded-xl border border-zinc-800 hover:border-orange-500/50 transition-all duration-300"
                >
                  <div className="flex justify-center mb-3 sm:mb-4">
                    <div className="p-2 sm:p-3 bg-orange-500/10 rounded-lg">
                      <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-orange-500">
                        {item.icon}
                      </div>
                    </div>
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 text-white">{item.title}</h3>
        ...
        <Container>
          ...
          >
            ...
            >
              <Link 
                to="/contact" 
                className="inline-flex items-center gap-1 sm:gap-2 bg-orange-500 hover:bg-orange-600 text-white px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 shadow-lg shadow-orange-500/20"
              >
